...
![alt tag](https://www.dofactory.com/img/diagrams/javascript/javascript-facade.jpg)


The objects participating in this pattern are:

__Facade__ -- In sample code: Mortgage
- knows which subsystems are responsible for a request
- delegates client requests to appropriate subsystem objects

__Sub Systems__ -- In sample code: Bank, Credit, Background
...
![alt tag](https://refactoring.guru/images/patterns/diagrams/chain-of-responsibility/solution1-en-2x.png)
